...
<div class="card card--<?php echo esc_attr( $card_layout ); ?>">
	...
	if ( ! empty( $card_image_id ) ) :
		echo wp_get_attachment_image(
			...
			[
				'class' => 'card__img',
				'sizes' => '(min-width: 748px) 33%, 100vw',
			]
		);
	endif;
	?>
	...
	<?php if ( ! empty( $card_link ) ) : ?>
		<a class="card__link" href="<?php echo esc_attr( $card_link['url'] ); ?>" target="<?php echo esc_attr( $card_link['target'] ); ?>"><?php echo esc_html( $card_link['title'] ); ?></a>
	<?php endif; ?>
</div><!--.card-->
